...
public abstract class Model implements IModel {
	...
	public Model(/* non_null */ String filename, String key, String[] keys) throws FileNotFoundException {
		if (filename == null) {
	...
	public boolean insertAnswer(IAnswers a) throws IOException {
		...
		fw.write(a.toStringToFile() + System.lineSeparator());	//appends the string to the file
	    fw.close();
		return true;
	}
