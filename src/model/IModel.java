...
public interface IModel {
	...
	/**
	 * Ritorna la prima riga che deve avere per la corretta formattazione
	 * @return stringa della prima riga
	 */
	public String getFirstLine();
	/**
	 * Ritorna la seconda riga che deve avere per la corretta formattazione
	 * @return
	 */
	public String getSecondLine();
//	public boolean reset(boolean all);
//	public boolean remove(IAnswers a);
