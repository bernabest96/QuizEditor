...
//			{new String[] {"category", "question", "A", "B", "C", "D", "A", "caption" }}
	...
	public void stringThrowIllegalMCDCCoverage() {
		AnswerMC a = new AnswerMC(0, strInp[0], strInp[1], strInp[2], strInp[3], strInp[4], strInp[5], strInp[6], strInp[7]);
	}
	
	@Test
	public void StatementCoverage() {
		AnswerMC a = new AnswerMC(0, "category", "question", "A", "B", "C", "D", "A", "caption");
