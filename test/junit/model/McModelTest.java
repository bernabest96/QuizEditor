...
//	}
	...
	public void insert01() throws IOException {
		...
		ans[0] = new AnswerMC(0, "category_a", "question01", "A", "B", "C", "D", "D", "this is cap");
		ans[1] = new AnswerMC(0, "category_b", "question02", "A", "B", "C", "D", "D", "this is cap");
		ans[2] = new AnswerMC(0, "category_c", "question with \"quote\"", "A", "B", "C", "D", "D", "this is cap");
		ans[3] = new AnswerMC(0, "category_a", "question with " + System.lineSeparator() + "line separator", "A", "B", "C", "D", "D", "this is cap");
	...
	public void insert02() throws IOException {
		assertFalse(m.insertAnswer(new AnswerTF(0, " ", " ", true, "caption")));
	}
	...
	public void hasWrongLines01() throws IOException {
		...
		ans[0] = new AnswerMC(0, "category_a", "question01", "A", "B", "C", "D", "D", "this is cap");
		ans[1] = new AnswerMC(0, "category_b", "question02", "A", "B", "C", "D", "D", "this is cap");
		ans[2] = new AnswerMC(0, "category_c", "question03", "A", "B", "C", "D", "D", "this is cap");
		ans[3] = new AnswerMC(0, "category_a", "question03", "A", "B", "C", "D", "D", "this is cap");
		assertTrue(m.insertAnswer(ans[0]));
		assertTrue(m.insertAnswer(ans[1]));
		assertTrue(m.insertAnswer(ans[2]));
		assertTrue(m.insertAnswer(ans[3]));		
	...
	public void hasWrongLines02() throws IOException {
		m.insertAnswer(new AnswerMC(0, "category_a", "sdad", "A", "C", "D", "F", "A", "this is captain america"));
		//append string to file
		FileWriter fw = new FileWriter(FILEPATH_CORRECT, true);
		fw.write("\"dddddddddd\", \"dadasdasd\"" + System.lineSeparator());
		fw.close();
		///////////
		m.insertAnswer(new AnswerMC(0, "category_b", "sdad", "A", "C", "D", "F", "A", "this is captain america"));
		assertTrue(m.hasWrongLines());
	...
	public void readAnswers01() throws IOException {
		...
		ans[1] = new AnswerMC(0, "category_b", "question02", "A", "B", "C", "D", "D", "this is cap");
		ans[2] = new AnswerMC(0, "category_c", "question03", "A", "B", "C", "D", "D", "this is cap");
		ans[3] = new AnswerMC(0, "category_a", "question04", "A", "B", "C", "D", "D", "this is cap");
		ans[4] = new AnswerMC(0, "category_a", "question05", "A", "B", "C", "D", "D", "this is cap");
		ans[5] = new AnswerMC(0, "category_c", "question06", "A", "B", "C", "D", "D", "this is cap");
	...
	public void hasWrongLinesConditionTest() throws IOException {
		AnswerMC[] ans = new AnswerMC[4];
		ans[0] = new AnswerMC(0, "category_a", "question01", "A", "B", "C", "D", "A", "this is cap");
		ans[1] = new AnswerMC(0, "category_b", "question02", "A", "B", "C", "D", "B", "this is cap");
		ans[2] = new AnswerMC(0, "category_c", "question03", "A", "B", "C", "D", "C", "this is cap");
		ans[3] = new AnswerMC(0, "category_a", "question03", "A", "B", "C", "D", "D", "this is cap");
		assertTrue(m.insertAnswer(ans[0]));
		assertTrue(m.insertAnswer(ans[1]));
		assertTrue(m.insertAnswer(ans[2]));
	...
	/***get first line tests **********************/
	@Test
	public void testFirstLine01() {
		assertEquals("\"MC\"", m.getFirstLine());
	}
	
	@Test
	public void testSecondLine01() {
		assertEquals("\"category\",\"question\",\"A\",\"B\",\"C\",\"D\",\"answer\",\"caption\"", m.getSecondLine());
	}
