...
//	private BufferedWriter bw = null;
	...
	public void hasKey01() throws FileNotFoundException, IOException {
		Model m = new TfModel(FILEPATH_NOT_CORRECT);
	...
	public void insert01() throws IOException {
		...
		ans[0] = new AnswerTF(0, "category_a", "question01", true, "this is cap");
		ans[1] = new AnswerTF(0, "category_b", "question02", false, "this is cap");
		ans[2] = new AnswerTF(0, "category_c", "question with \"quote\"", true, "this is cap");
		ans[3] = new AnswerTF(0, "category_a", "question with " + System.lineSeparator() + "line separator", true, "this is cap");
		...
		assertEquals(ans[0].toStringToFile(), br.readLine());
		assertEquals(ans[1].toStringToFile(), br.readLine());
		assertEquals(ans[2].toStringToFile(), br.readLine());
		assertEquals(ans[3].toStringToFile(), br.readLine());
		br.close();
	}
	
	@Test
	public void insert02() throws IOException {
		assertFalse(m.insertAnswer(new AnswerMC(0, "category", "question", "A", "B", "C", "D", "A", "caption")));
	}
	...
	public void hasWrongLines01() throws IOException {
		...
		ans[0] = new AnswerTF(0, "category_a", "question01", true, "this is cap");
		ans[1] = new AnswerTF(0, "category_b", "question02", false, "this is cap");
		ans[2] = new AnswerTF(0, "category_c", "question03", true, "this is cap");
		ans[3] = new AnswerTF(0, "category_a", "question03", true, "this is cap");
		assertTrue(m.insertAnswer(ans[0]));
		assertTrue(m.insertAnswer(ans[1]));
		assertTrue(m.insertAnswer(ans[2]));
		assertTrue(m.insertAnswer(ans[3]));		
	...
	public void hasWrongLines02() throws IOException {
		m.insertAnswer(new AnswerTF(0, "category_a", "sdad", true, "this is captain america"));
		//append string to file
		FileWriter fw = new FileWriter(FILEPATH_CORRECT, true);
		fw.write("\"dddddddddd\", \"dadasdasd\"" + System.lineSeparator());
		fw.close();
		///////////
		m.insertAnswer(new AnswerTF(0, "category_b", "sdad", false, "this is captain america"));
		assertTrue(m.hasWrongLines());
	...
	public void readAnswers01() throws IOException {
		...
		ans[0] = new AnswerTF(0, "category_a", "question01", false, "this is cap");
		ans[1] = new AnswerTF(0, "category_b", "question02", true, "this is cap");
		ans[2] = new AnswerTF(0, "category_c", "question03", true, "this is cap");
		ans[3] = new AnswerTF(0, "category_a", "question04", false, "this is cap");
		ans[4] = new AnswerTF(0, "category_a", "question05", false, "this is cap");
		ans[5] = new AnswerTF(0, "category_c", "question06", false, "this is cap");
	...
	public void removeWrongLines01() throws IOException {
		...
		ans[0] = new AnswerTF(0, "category_a", "question01", false, "this is cap");
		ans[1] = new AnswerTF(0, "category_b", "question02", true, "this is cap");
		ans[2] = new AnswerTF(0, "category_c", "question03", false, "this is cap");
		ans[3] = new AnswerTF(0, "category_a", "question04", true, "this is cap");
		ans[4] = new AnswerTF(0, "category_a", "question05", true, "this is cap");
		ans[5] = new AnswerTF(0, "category_c", "question06", false, "this is cap");
		m.insertAnswer(ans[0]);
		m.insertAnswer(ans[1]);
		m.insertAnswer(ans[2]);
	...
	public void removeWrongLines02() throws IOException {
		...
		ans[3] = new AnswerTF(0, "category_a", "question04", false, "this is cap");
		ans[4] = new AnswerTF(0, "category_a", "question05", true, "this is cap");
		ans[5] = new AnswerTF(0, "category_c", "question06", true, "this is cap");
		m.insertAnswer(ans[0]);
		m.insertAnswer(ans[1]);
		m.insertAnswer(ans[2]);
		m.insertAnswer(ans[3]);
	...
	public void firstLineTes01() {
		assertEquals("\"TF\"", m.getFirstLine());
	}
	
	public void secondLineTest01() {
		assertEquals("\"category\",\"question\",\"answer\",\"caption\"", m.getSecondLine());
	}
